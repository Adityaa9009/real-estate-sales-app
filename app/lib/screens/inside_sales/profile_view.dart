          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  emp?.name ?? 'Inside Sales Representative',
                  style: GoogleFonts.sora(
                    fontSize: 18,
                    fontWeight: FontWeight.w700,
                ...
                RoleBadge(role: emp?.role ?? AppRole.insideSales),
                ...
                const SizedBox(height: 14),
                _infoRow(Icons.location_on_outlined, 'Work Office', OfficeLocation.address),
                const SizedBox(height: 14),
                _infoRow(Icons.security_rounded, 'System Access', 'Inside Sales Role Active'),
